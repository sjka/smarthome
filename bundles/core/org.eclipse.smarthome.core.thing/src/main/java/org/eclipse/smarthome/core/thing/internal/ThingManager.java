...
public class ThingManager implements ThingTracker, ThingTypeMigrationService {
    ...
    private ThingHandlerCallback thingHandlerCallback = new ThingHandlerCallback() {
        ...
        public void stateUpdated(ChannelUID channelUID, State state) {
            inboundCommunication.stateUpdated(channelUID, state);
        }

        @Override
        public void postCommand(ChannelUID channelUID, Command command) {
            inboundCommunication.postCommand(channelUID, command);
        }

        @Override
        public void channelTriggered(Thing thing, ChannelUID channelUID, String event) {
            inboundCommunication.channelTriggered(thing, channelUID, event);
        }
    ...
    protected void setInboundCommunication(InboundCommunication inboundCommunication) {
        this.inboundCommunication = inboundCommunication;
    }

    protected void unsetInboundCommunication(InboundCommunication inboundCommunication) {
        this.inboundCommunication = null;
    }
